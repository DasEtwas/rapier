...
impl JointSet {
    ...
    ///
    /// This is useful for finding the generation number when only the joint position `i` is known.
    ///
    /// Generation numbers are used to protect from the ABA problem because the joint position `i`
    ...
    /// Gets a mutable reference to a joint with the given handle without a known generation.
    ///
    /// This is useful for finding the generation number when only the joint position `i` is known.
    ///
    /// Generation numbers are used to protect from the ABA problem because the joint position `i`
